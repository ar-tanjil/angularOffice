...
const routes: Routes = [
  ...
  { path: "designation", component: DesignationsComponent , canActivate: [AuthGuard]  },
  { path: "payroll", component: PayrollComponent , canActivate: [AuthGuard] },
  { path: "salary/:mode/:id", component: AddSalaryComponent , canActivate: [AuthGuard]  },
  { path: "salaryDetails/:id", component: SalaryDetailsComponent , canActivate: [AuthGuard]  },
  { path: "attendance", component: AttendanceComponent , canActivate: [AuthGuard]  },
  { path: "tax", component: TaxComponent , canActivate: [AuthGuard]  },
  { path: "leave", component: LeavesComponent  , canActivate: [AuthGuard] },
